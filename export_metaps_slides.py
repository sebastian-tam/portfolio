#!/usr/bin/env python3
"""
Export Metaps Mobile App Marketing PowerPoint to high-resolution JPEGs
"""
...
def export_pptx_to_jpegs(pptx_path, output_dir):
...
def main():
    pptx_file = '/Users/sebastiantam/Desktop/Metaps Mobile App Marketing.ppt'
    output_dir = '/Users/sebastiantam/portfolio/metaps-mam'
    ...
    # Export slides
    num_slides = export_pptx_to_jpegs(pptx_file, output_dir)
